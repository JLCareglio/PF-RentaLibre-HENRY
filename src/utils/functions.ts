...
export const createRatingProduct =
  trpc.rating.createRatingProduct.useMutation();
...
export function handleChangeUser(
...
export function handleChangeProduct(
  e: ChangeEvent<HTMLInputElement>,
  changeState: any,
  state: any
) {
...
export function handleChangeRating(
  e: ChangeEvent<HTMLInputElement>,
  changeState: any,
  state: any
) {
